...
define([
    'sound/audiohandler'
		...
		var BeatDetector = function (AudioHandler, lowThreshold, midThreshold, highThreshold, globalThreshold, maxAmplitudesDomain) {
        ...
        var lmht = this.audio.getLowMidHighAverageFrequency();
